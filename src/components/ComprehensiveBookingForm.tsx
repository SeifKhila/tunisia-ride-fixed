...
const bookingSchema = z.object({
  ...
  passengers: z.string().refine(val => val && parseInt(val) > 0, "Number of passengers is required"),
  luggage: z.string().refine(val => val && parseInt(val) >= 0, "Number of luggage is required"),
