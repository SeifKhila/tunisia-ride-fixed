...
const translations = {
  en: {
    ...
    'calc.promo_banner': '✨ Same price both ways + 10% OFF returns!',
    'calc.get_quote': '✨ Get Your Quote',
    'calc.quote_desc': 'Select your pickup and destination to see the fixed price instantly',
    'calc.from_location': '📍 From Location',
    'calc.to_location': '📍 To Location',
    'calc.select_from': 'Select departure location',
    'calc.select_to': 'Select destination location',
    'calc.one_way': 'One-Way',
    'calc.return_trip': 'Return Trip',
    'calc.fixed_price': '🎯 Fixed Price',
    'calc.return_price': '🎯 Return Trip Price',
    'calc.save': 'Save',
  ...
  fr: {
    ...
    'calc.promo_banner': '✨ Même prix dans les deux sens + 10% DE RÉDUCTION retours!',
    ...
    'calc.from_location': '📍 Depuis le Lieu',
    'calc.to_location': '📍 Vers le Lieu',
    'calc.select_from': 'Sélectionner le lieu de départ',
    'calc.select_to': 'Sélectionner le lieu de destination',
    'calc.one_way': 'Aller Simple',
    'calc.return_trip': 'Aller-Retour',
    'calc.fixed_price': '🎯 Prix Fixe',
    'calc.return_price': '🎯 Prix Aller-Retour',
    'calc.save': 'Économisez',
  ...
  ar: {
    ...
    'calc.promo_banner': '✨ نفس السعر في الاتجاهين + خصم 10% على العودة!',
    'calc.get_quote': '✨ احصل على عرض السعر',
    'calc.quote_desc': 'اختر نقطة الالتقاط والوجهة لرؤية السعر الثابت فورياً',
    'calc.from_location': '📍 من الموقع',
    'calc.to_location': '📍 إلى الموقع',
    'calc.select_from': 'اختر موقع الانطلاق',
    'calc.select_to': 'اختر موقع الوجهة',
    'calc.one_way': 'ذهاب فقط',
    'calc.return_trip': 'ذهاب وإياب',
    'calc.fixed_price': '🎯 السعر الثابت',
    'calc.return_price': '🎯 سعر الذهاب والإياب',
    'calc.save': 'وفر',
